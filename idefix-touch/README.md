...
## Accesso da telefono o PC

Collegarsi all’hotspot **Raspberry-Server** e aprire
[http://10.42.0.1:8080](http://10.42.0.1:8080). Se il telefono segnala che la rete
non ha Internet, mantenere la connessione. Via Ethernet usare
[http://192.168.10.1:8080](http://192.168.10.1:8080).
...
Dopo aver ricopiato i file, riavviare entrambi i servizi. Se cambia l’installer
(incluso l’aggiornamento che abilita l’accesso dalla rete) oppure l’IP del
destinatario, rieseguire prima `sudo bash install-services.sh 192.168.10.2`,
sostituendo l’IP se necessario.
...
Se la pagina non si apre dal telefono, verificare la connessione all’hotspot.
Su Idefix, `sudo ss -ltnp 'sport = :8080'` deve mostrare `0.0.0.0:8080`.
